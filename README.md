...
Esta política describe cómo Zero Colour (en adelante, "el Juego"), desarrollado por coffeeandcookies2k, trata la información de sus usuarios.

1. Información que recopilamos
El Juego está diseñado para recopilar la menor cantidad de información posible. No recopilamos nombre, dirección, número de teléfono, ubicación ni contactos.

Progreso de juego: tu avance, cartas, oro y estadísticas se guardan únicamente en tu dispositivo. No se envían a ningún servidor.
Identificador de compra: para verificar la compra del juego completo, el Juego genera un identificador aleatorio que no está vinculado a tu identidad. Solo se usa para confirmar que la compra es válida.
Datos de la compra: al comprar el juego completo, se procesan el identificador del producto, el identificador de la transacción y el comprobante de compra, necesarios para verificarla.
2. Pagos
Las compras dentro del Juego se procesan a través de Aptoide y su sistema de pagos. Nunca tenemos acceso a los datos de tu tarjeta ni a tu información de pago. Esos datos los maneja Aptoide según su propia política de privacidad.

3. Cómo usamos la información
La información de compra se usa exclusivamente para verificar que la compra es legítima y desbloquear el juego completo. No se usa para publicidad, perfiles ni ningún otro fin.

4. Compartir información
No vendemos, alquilamos ni compartimos tu información con terceros, salvo lo estrictamente necesario para procesar y verificar la compra (Aptoide y nuestro servidor de verificación).

5. Publicidad y seguimiento
El Juego no contiene publicidad y no utiliza herramientas de seguimiento ni analítica de terceros.
